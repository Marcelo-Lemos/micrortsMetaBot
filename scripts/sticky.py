...
def specific_experiment(adversary, sticky, seed, output):
    ...
    create_dirs(f'{working_dir}/train_choices')
    create_dirs(f'{working_dir}/train_qvalues')
    create_dirs(f'{working_dir}/train_features')
    create_dirs(f'{working_dir}/test_choices')
    create_dirs(f'{working_dir}/test_qvalues')
    create_dirs(f'{working_dir}/test_features')
...
def multithreading_experiments(adversary, sticky, iterations, output):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--adversary')
